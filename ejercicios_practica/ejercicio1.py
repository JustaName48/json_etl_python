...
def serializar():
    ...
    json_data = {
                ...
                "guardarropa": [
                {
                 "prenda": "sombrerito de copa",
                 "cantidad": 3   
                },
                {
                 "prenda": "lentes de sol",
                 "cantidad": 85   
                },   
                {
                 "prenda": "smoking",
    ...
    with open('mi_pio_json.json', 'w') as jsonfile: 
        data = [json_data]
...
def deserializar():
    ...
    with open("mi_pio_json.json", "r", encoding='latin1') as jsonfile:
        pio_data = json.load(jsonfile)
    ...
    # en pantalla y comparelo contra el JSON que generó en la función anterior
        ...
        print('El contenido del archivo mi_pio_json es:')
        print(json.dumps(pio_data, indent = 4))
